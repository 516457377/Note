...
上标：X<sub>2</sub>，下标：O<sup>2</sup>2、
...
10、markdown编辑的时候有时候需要很多空格用来间隔文字或者图片，但是在md编辑里面打的太多也只会显示一个。如果需要多个就需要用如下方式。
半方大的空白&ensp;或&#8194;文字
全方大的空白&emsp;或&#8195;文字
不断行的空白格&nbsp;或&#160;文字&#9;文字
```
...
![markdown](https://www.mdeditor.com/images/logos/markdown.png "markdown")                 ![markdown](https://www.mdeditor.com/images/logos/markdown.png "markdown")
