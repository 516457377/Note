public class BankInfo {
    ...
    /**输入银行卡信息*/
    public static String getNameOfBank(String num, int offset) {
        long numBin;
        if (num.length() < 6) {
            return "输入号码太短无法判断";
        } else if (num.length() > 19) {
            return "您输入的卡号过长，请检查卡号";
        } else {
            num = num.substring(0, 6);
        }
        
        numBin = Long.valueOf(num); 
        
        int index = binarySearch(bankBin, numBin);
    ...
    /** 输入银行卡信息 */
    public static String getNameOfBank(long num, int offset) {
        String strBin = String.valueOf(num);
        
        if (strBin.length() < 6) {
            return "输入号码太短无法判断";
        } else {
            strBin = strBin.substring(0, 6);
        }
        
        num = Long.valueOf(strBin); 
        
        int index = binarySearch(bankBin, num);
